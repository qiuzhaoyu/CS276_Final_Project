...
#SBATCH -o /public_bme2/bme-dgshen/ZhaoyuQiu/CS276_Final_Project/result_show/out.out  # 标准输出日志
#SBATCH -e /public_bme2/bme-dgshen/ZhaoyuQiu/CS276_Final_Project/result_show/err.err  # 错误日志
#SBATCH -t 0:30:00 
...
python -u /public_bme2/bme-dgshen/ZhaoyuQiu/CS276_Final_Project/result_show/dino.py
